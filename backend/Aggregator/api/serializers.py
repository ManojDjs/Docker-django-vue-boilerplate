...
class Team_S(serializers.ModelSerializer):
    class Meta:
        model = Team
        fields = '__all__'

class Testmonials_S(serializers.ModelSerializer):
    class Meta:
        model = Testmonials
        fields = '__all__'


class Sites_S(serializers.ModelSerializer):
    class Meta:
        model=Sites
        fields="__all__"

class Course_S(serializers.ModelSerializer):
    User_Course=Sites_S(many=True, read_only=True)
    class Meta:
        model=Course
        fields="__all__"
