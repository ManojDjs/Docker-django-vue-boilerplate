...
var script = {
    ...
    methods: {
        ...
        onListFocus(event, listType) {
            ...
            const index = selectedFirstItem ? utils.ObjectUtils.findIndexInList(selectedFirstItem, this.$refs[listType].$el.children) : '0';
...
const _hoisted_4 = ["id", "onClick", "onDblclick", "aria-selected"];
...
const _hoisted_8 = ["id", "onClick", "onDblclick", "aria-selected"];
const _hoisted_9 = {
  key: 1,
