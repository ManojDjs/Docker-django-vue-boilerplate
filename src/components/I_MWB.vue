...
export default {
    data(){
        return{
            isq_link:Json[0]['MWB'],
            total:Json[0]['MWB']['Total'],
            questionlink:Json[0]['MWB']['Questions'],
            submission_link:Json[0]['MWB']['Answers'],
            edit:Json[0]['MWB']['Edit'],
        ...
        methods:{
         ...
         afteredit(){
             var i;
                // console.log(this.get_questions.data) checking questions
                 for(i=0;i<this.get_qa[0]['MWB'].length;i++){
                     if(this.get_qa[0]['MWB'][i]['question_name']['question_type']=='Options'){
                         if(this.get_qa[0]['MWB'][i]['answer']=='1'){
                                 this.get_qa[0]['MWB'][i]['answer']={name: 'None of the Time', value: 1}

                         }
                         if(this.get_qa[0]['MWB'][i]['answer']=='2'){
                                 this.get_qa[0]['MWB'][i]['answer']={name: 'Rarely', value: 2}

                         }
                         if(this.get_qa[0]['MWB'][i]['answer']=='3'){
                                 this.get_qa[0]['MWB'][i]['answer']={name: 'Some of the time', value: 3}

                         }
                         if(this.get_qa[0]['MWB'][i]['answer']=='4'){
                                 this.get_qa[0]['MWB'][i]['answer']={name: 'Often', value: 4}

                         }
                         if(this.get_qa[0]['MWB'][i]['answer']=='5'){
                                 this.get_qa[0]['MWB'][i]['answer']={name: 'All of the Time ', value: 5}

                         }
                     }
                     if(this.get_qa[0]['MWB'][i]['question_name']['question_type']=='YESNO'){
                          if(this.get_qa[0]['MWB'][i]['answer']=='1'){
                                 this.get_qa[0]['MWB'][i]['answer']='YES'

                         }
                          if(this.get_qa[0]['MWB'][i]['answer']=='0'){
                                 this.get_qa[0]['MWB'][i]['answer']='NO'

                         }
                     }

                                    this.Answers_KV.push({
                                        "editid":this.get_qa[0]['MWB'][i]['id'],
                                        "qid":this.get_qa[0]['MWB'][i]['question_name']['id'],
                                        "answer": this.get_qa[0]['MWB'][i]['answer'],
                                        // "main_question_set":this.getuser,
                                        "question_name": this.get_qa[0]['MWB'][i]['question_name']['question'],
                                        "question_type":this.get_qa[0]['MWB'][i]['question_name']['question_type'],
         ...
         watch:{
            get_q_status(){
                ...
                this.localedit=true
                var i;
                console.log('i came after submission')
                this.Answers_KV=[]
                // console.log(this.get_questions.data) checking questions
                 for(i=0;i<this.get_qa[0]['MWB'].length;i++){
                     if(this.get_qa[0]['MWB'][i]['question_name']['question_type']=='Options'){
